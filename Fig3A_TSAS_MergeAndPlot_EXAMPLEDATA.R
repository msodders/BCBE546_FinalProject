...
MPAO1_feat <- read.delim("MPAO1_feature_table_abbrev.txt", header = TRUE, sep = "\t")
Ess538 <- read.delim("Essential_genes-538.txt", header = TRUE, sep = "\t")
merged538 <- merge(MPAO1_feat, Ess538, by="Gene_ID")
